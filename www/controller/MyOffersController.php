...
//        $_SESSION['correctingClosed'] = Work::getClosedMyCorrections();
        ...
        for ($i = 0; $i < 5; $i++) {
            $_SESSION['correctingOpen'][$i]['id'] = $i;
        ...
        for ($i = 0; $i < 5; $i++) {
            $_SESSION['correctingClosed'][$i]['id'] = $i;
